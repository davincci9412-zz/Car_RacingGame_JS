var ytAboutLayer = (function () {
	...
	ytAboutLayer.prototype.addAboutTxt = function () {
		...
		var txtList = [
			"This game is for PLATA Network.",
			"The NFT Army represents the total number of NFTs that you hold, while Stamina, Engine, Speed and the others are calculated bassed on the attributes of the NFTs that you hold. The $PLATA and $GCC bonus are activted if you hold these tokens in your wallet."
		];
